    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                messages: {
                    "default": "Arrastre o haga click para subir una imagen",
                    replace: "Arrastre o haga click para reemplazar una imagen",
                    remove: "Remover",
                    error: "Ooops, algo salio mal"
                },
                error: {
                    fileSize: "La imagen es muy grande ({{ value }} max).",
                    minWidth: "La imagen es muy pequeña ({{ value }}}px min).",
                    maxWidth: "The image width is too big ({{ value }}}px max).",
                    minHeight: "The image height is too small ({{ value }}}px min).",
                    maxHeight: "The image height is too big ({{ value }}px max).",
                    imageFormat: "Formato invalido, solo ({{ value }}).",
                    fileExtension: "Formato invalido, solo ({{ value }})."
                },
                tpl: {
